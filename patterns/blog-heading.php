...
<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--xl)">
	...
	<p class="has-text-align-center has-neutral-600-color has-text-color"><?php echo esc_html__( 'Tips on building with WordPress blocks, product news and stories from the Bloqra community.', 'bloqra' ); ?></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
