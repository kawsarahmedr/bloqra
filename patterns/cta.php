...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--2-xl);padding-bottom:var(--wp--preset--spacing--2-xl)">
	...
	<div class="wp-block-group alignwide has-primary-dark-gradient-background has-background" style="border-radius:20px;padding-top:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--lg)">
		<!-- wp:paragraph {"align":"center","className":"is-style-subheading","textColor":"accent"} -->
		<p class="has-text-align-center is-style-subheading has-accent-color has-text-color"><?php echo esc_html__( 'Ready when you are', 'bloqra' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<p class="has-text-align-center has-primary-100-color has-text-color"><?php echo esc_html__( 'Activate the theme, open the Site Editor and start building beautiful pages in minutes.', 'bloqra' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--xs)">
			<!-- wp:button {"backgroundColor":"white","textColor":"primary-700","className":"is-style-fill"} -->
			<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-primary-700-color has-white-background-color has-text-color has-background wp-element-button" href="#"><?php echo esc_html__( 'Get started free', 'bloqra' ); ?></a></div>
			<!-- /wp:button -->
			<!-- wp:button {"textColor":"white","className":"is-style-outline"} -->
			<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-white-color has-text-color wp-element-button" href="#"><?php echo esc_html__( 'Learn more', 'bloqra' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
